 ...
 * - Уровни 11–91 — «Антикотопарк»: используют ту же логику, что уровень 10,
 *   конфигурация загружается из json/levels/levelNNN.json.
 * - Уровни 92–100 — доступны в классическом режиме.
 */
...
// Уровни 62–87 — «Антикотопарк» (новые анти-уровни)
for (let id = 62; id <= 91; id++) {
  LEVELS[id] = { id, title: `Уровень ${id}`, enabled: true, mode: "anti" };
}

// Уровни 92–100 — классический режим (JSON уже есть)
for (let id = 92; id <= 100; id++) {
