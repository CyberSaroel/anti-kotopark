 ...
 * - Уровни 11–81 — «Антикотопарк»: используют ту же логику, что уровень 10,
 *   конфигурация загружается из json/levels/levelNNN.json.
 * - Уровни 82–100 — доступны в классическом режиме.
 */
...
// Уровни 62–81 — «Антикотопарк» (новые анти-уровни)
for (let id = 62; id <= 81; id++) {
  LEVELS[id] = { id, title: `Уровень ${id}`, enabled: true, mode: "anti" };
}

// Уровни 82–100 — классический режим (JSON уже есть)
for (let id = 82; id <= 100; id++) {
