 ...
 * - Уровни 11–61, 72–81 — «Антикотопарк»: используют ту же логику, что уровень 10,
 *   конфигурация загружается из json/levels/levelNNN.json.
 * - Остальные уровни (62–71, 82–100) — доступны в классическом режиме.
 */
...
// Уровни 72–81 — «Антикотопарк» (новые анти-уровни)
for (let id = 72; id <= 81; id++) {
